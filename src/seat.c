...
/* Cycle focus among mapped windows in tiling order. */
static void focus_direction (
...
static void keyboard_key (
	...
	int count = xkb_state_key_get_syms(keyboard->wlr_keyboard->xkb_state,
			keycode, &syms);
